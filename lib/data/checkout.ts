...
export const deliveryOptions: DeliveryOption[] = [
  {
    id: "standard",
    name: "التوصيل العادي",
    description: "التوصيل إلى عنوانك خلال أيام العمل المعتمدة في الإعدادات",
    fee: 1500,
    eta: "حسب إعدادات المتجر",
  },
  {
    id: "pickup",
    name: "استلام من المتجر",
    description: "استلام مجاني من مقر المتجر عند التفعيل في الإعدادات",
    fee: 0,
    eta: "حسب إعدادات المتجر",
  },
];
